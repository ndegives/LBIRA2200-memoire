...
```{r, echo=TRUE}
# Plot général
ggplot(data,aes(x=annee,y=rendement_MS, color=variete)) + geom_point(alpha = 0.5, size=3) + 
               labs(color = "Variété", 
                    x= "Année",
                    y= "Rendement_MS",
                    title="Rendement par année et par variété")
...
# Variabilité des rendements annuel
...
On observe que l'année n'est pas un facteur significatifs donc peut d'impact météo sur les rendements moyens de sorgho.
...
# Variabilité des rendements avec annee et variete en facteur fixe
...
# Variabilité des rendements avec variete en facteur fixe et annee en facteur aléatoire
