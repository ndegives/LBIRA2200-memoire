...
Récupère le 2 ème percentile des distributions de Dmin pour estimer le paramètre.
...
Dmax coresspond au diamètre maximum de la distribution des racines nodales observées.  
Le Dmax global des racines est de : `r Dmax`.

## Drange

Drange, la range relative de diamètre, est calculé avec les diamètre extrème comme :
