...
```{r, echo=TRUE}
ArchiSimple(par=par_sorgho,exporttype = 1,time = 30)
```
...
```{r, echo=TRUE}
ArchiSimple(par=par_sorgho,exporttype = 2,time = 30)
```
...
```{r, echo=TRUE}
ArchiSimple(par=params_maize,exporttype = 1,time = 30)
```
...
```{r, echo=TRUE}
ArchiSimple(par=params_mono,exporttype = 1,time = 30)
```
